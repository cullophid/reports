...
/* harmony import */ var _server_helpers_photon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../server/helpers/photon */ "./server/helpers/photon.ts");
/* harmony import */ var _server_helpers_jwt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../server/helpers/jwt */ "./server/helpers/jwt.ts");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  try {
    ...
    const {
      email
    } = await Object(_server_helpers_jwt__WEBPACK_IMPORTED_MODULE_2__["verifySigninToken"])(signin_token);
    let [user] = await _server_helpers_photon__WEBPACK_IMPORTED_MODULE_1__["photon"].users.findMany({
      where: {
        email
      }
    });
    const refreshToken = await Object(_server_helpers_jwt__WEBPACK_IMPORTED_MODULE_2__["createRefreshToken"])(user);

    if (!user) {
      user = await _server_helpers_photon__WEBPACK_IMPORTED_MODULE_1__["photon"].users.create({
        data: {
          email,
          firstName: "",
          lastName: "",
    ...
    await _server_helpers_photon__WEBPACK_IMPORTED_MODULE_1__["photon"].users.update({
      where: {
        id: user.id
      },
      data: {
    ...
    res.status(500).send(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(e));
  }
});
...
/***/ 9:
/*!*********************************!*\
  !*** multi ./pages/api/auth.ts ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/andreasmoller/code/reports/pages/api/auth.ts */"./pages/api/auth.ts");
